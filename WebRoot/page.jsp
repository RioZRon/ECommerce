...
<body class="page_body">
	...
	<div  class="page_nav">
		<div class="page_nav_l">
			<div class="location">
				<a href="zindex">首页</a>&gt;<a href="${requestScope.url }">
								...
								<li>
									<div class="page_list_nr">
										<div class="page_list_nr_pic">
											<a href="dnr.action?id=${id}&did=${list.id}"><img
												src="${list.img}" /></a>
										</div>
										<div class="page_list_nr_wz">
											<h3>
												<a href="dnr.action?id=${id}&did=${list.id}">${list.title}</a>
											</h3>
											<p
												style="width:620px; height:70px; display:block; 
													overflow: hidden;">${list.text}</p>
										</div>
									</div>
								</li>
							</c:if>
			...
			<c:if
				test="${requestScope.listdan!=null||fn:length(requestScope.listdan) != 0}">
				<div class="flash" style="margin: 10px;padding: 10px">
