	...
	self.plugin.media = {
		edit : function() {
			var html = [
				...
				'<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="700" maxlength="4" />',
				'</div>',
				//height
				'<div class="ke-dialog-row">',
			...
			var dialog = self.createDialog({
				...
				yesBtn : {
					...
					click : function(e) {
						...
						if ((url.slice(-4).toUpperCase() == '.FLV') || (url.slice(-4).toUpperCase() == '.flv')) {
							var html = K.mediaImg(self.themesPath +'common/blank.gif', {
								src: 'kind/flv//Flvplayer.swf',
